...
- We evaluate whether non-invasive history (demographics, sexual/reproductive history, contraception, smoking, STDs) can triage patients at higher risk of biopsy-positive disease
...
baseline_cv = {
    "Logistic Regression": (0.1002, 0.0521),
    "Random Forest": (0.1042, 0.0143),
    "XGboost": (0.0826, 0.0144),
}
...
test_metrics = {
    ...
    "F1_Pos": 0.118,
    "Specificity": 0.968,
    "Confusion": {"TN":151, "FP":5, "FN":10, "TP":1},
...
- Reproductive history: more pregnancies ↑ risk.
- Number of sexual partners: more partners ↑ risk.
- Hormonal contraception: longer duration & ever-use ↑ risk
- Age at first intercourse: earlier debut ↑ risk
:::
...
- **Future Work:**
  ...
  * Implementing a cost-sensitive learning approach could penalize misclassifying positive cases more heavily
  * Additional feature engineering and domain expertise could further enhance predictive power

## Limitations
- Lack of Generalizability
- Low Sensitivity (Recall)
- Moderate Predictive Power: Low ROC-AUC
